...
namespace BinaryData
{
    ...
    const int            gradlew_batSize = 2314;
    ...
    const int            jucer_AnimatedComponentTemplate_cppSize = 1325;
    ...
    const int            jucer_AudioComponentTemplate_cppSize = 2866;
    ...
    const int            jucer_AudioPluginEditorTemplate_cppSize = 1316;

    extern const char*   jucer_AudioPluginEditorTemplate_h;
    const int            jucer_AudioPluginEditorTemplate_hSize = 941;

    extern const char*   jucer_AudioPluginFilterTemplate_cpp;
    const int            jucer_AudioPluginFilterTemplate_cppSize = 6028;

    extern const char*   jucer_AudioPluginFilterTemplate_h;
    const int            jucer_AudioPluginFilterTemplate_hSize = 2240;

    extern const char*   jucer_ComponentTemplate_cpp;
    const int            jucer_ComponentTemplate_cppSize = 2073;

    extern const char*   jucer_ComponentTemplate_h;
    const int            jucer_ComponentTemplate_hSize = 2004;
    ...
    const int            jucer_ContentCompTemplate_cppSize = 978;

    extern const char*   jucer_ContentCompTemplate_h;
    const int            jucer_ContentCompTemplate_hSize = 851;

    extern const char*   jucer_InlineComponentTemplate_h;
    const int            jucer_InlineComponentTemplate_hSize = 1236;

    extern const char*   jucer_MainConsoleAppTemplate_cpp;
    const int            jucer_MainConsoleAppTemplate_cppSize = 424;

    extern const char*   jucer_MainTemplate_NoWindow_cpp;
    const int            jucer_MainTemplate_NoWindow_cppSize = 1948;

    extern const char*   jucer_MainTemplate_Window_cpp;
    const int            jucer_MainTemplate_Window_cppSize = 3977;

    extern const char*   jucer_NewComponentTemplate_cpp;
    const int            jucer_NewComponentTemplate_cppSize = 1470;

    extern const char*   jucer_NewComponentTemplate_h;
    const int            jucer_NewComponentTemplate_hSize = 636;

    extern const char*   jucer_NewCppFileTemplate_cpp;
    const int            jucer_NewCppFileTemplate_cppSize = 267;

    extern const char*   jucer_NewCppFileTemplate_h;
    const int            jucer_NewCppFileTemplate_hSize = 247;

    extern const char*   jucer_NewInlineComponentTemplate_h;
    const int            jucer_NewInlineComponentTemplate_hSize = 1658;
    ...
    const int            jucer_OpenGLComponentTemplate_cppSize = 1422;
    ...
    const int            colourscheme_dark_xmlSize = 1027;

    extern const char*   colourscheme_light_xml;
    const int            colourscheme_light_xmlSize = 1027;
